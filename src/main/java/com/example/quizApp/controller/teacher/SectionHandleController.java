...
public class SectionHandleController {
	...
	ResponseEntity<Void> updateSection(@PathVariable String sectionNameToUpdate, @RequestBody SectionDTO sectionDTO) {
		SectionResult.Update res = sectionService.updateSection(sectionNameToUpdate, sectionDTO);
		return switch (res) {
